    ...
    {sites.map(item => {
        ...
        <div key={item}>
            <div style={{backgroundColor:'rgb(12,63,116)',color:'white',padding:'10px 0',display:'flex',justifyContent:'center'}}>
                ...
                <Link to={'/Appointment'}>
                    <div style={{marginRight:'20px',padding:'5px'}}>
                        <div style={{display:'flex',alignItems:'center',background:'rgb(214,158,46)'}} className="px-3 py-1 rounded">
                            ...
                            <div style={{marginLeft:'10px',textDecoration:'none',color:'white'}}><b>Appointment</b></div>
                        </div>
                    </div>
                </Link>
            </div>
            ...
            <div style={{display:'flex',margin:' 45px',alignItems:'center'}}>
                ...
                >
                    <div style={{borderRadius:'15px',padding:'25px',flexWrap:'wrap',display:'flex',justifyContent:'center',margin:'25px auto'}}>
                            ...
                            <div style={{display:'flex',textAlign:'center',justifyContent:'center',marginRight:'-15px'}}>
                                <div className="rounded" style={{width:'30%',padding:'5px',border:'3px solid rgb(173,18,95)'}}>
                                    <img src="../../../images/r4.jpg" width="100%" className=""/>
                                </div>
                                <div style={{fontSize:'20px',background:'rgb(173,18,95)',padding:'25px',color:'white',width:'50%'}} className="rounded">
                ...
                <div style={{display:'flex',justifyContent:'center',width:'100%',background:'rgb(29,112,29)',margin:'25px',borderLeft:'15px solid rgb(214,158,46)'}} className="rounded">
                <div style={{margin:'auto'}}><h1 style={{textAlign:'center',fontSize:'35px',fontWeight:'bold',color:'white'}}>Sites List Items</h1></div>
                    <div style={{display:'flex',justifyContent:'center',width:'100%',borderRadius:'15px',padding:'25px',flexWrap:'wrap'}}>
                        ...
                        {item.data.sites.map(items =>
                            <div style={{background:'rgb(214,158,46)',width:'200px',height:'220px',color:'white',padding:'10px',margin:'15px',border:'2px solid #fff'}} className="rounded" key={items.id}>
